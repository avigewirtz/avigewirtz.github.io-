...
* [Background](armlab/background.md)
  ...
  * [Logging in & out of armlab](armlab/background/logging-into-armlab/)
...
* [Navigating the filesystem](bash/navigating-filesystem.md)
  * [pwd (Print Working Directory)](bash/navigating-filesystem/pwd.md)
  * [cd (Change Working Directory)](bash/navigating-filesystem/cd.md)
  * [ls (List Directory Contents)](bash/navigating-filesystem/ls.md)
* [Understanding Working Directories](bash/understanding-working-directories.md)
* [Creating Directories](bash/creating-directories.md)
...
* [How Bash Executes Commands](bash/how-bash-executes-commands.md)
  * [Path Environment Variable](bash/how-bash-executes-commands/path-environment-variable.md)
...
* [Basic Commands](emacs/basic-commands.md)
...
* [More Advanced Commands](emacs/more-advanced-commands.md)
...
* [Git Fundamentals](git-and-github/git-fundamentals.md)
* [Obtaining a Git Repository](git-and-github/obtaining-a-git-repository.md)
...
* [Obtaining COS217 Assignment Repositories](git-and-github/obtaining-cos217-assignment-repositories.md)
* [COS217 Development Workflow](git-and-github/cos217-development-workflow.md)
* [Revisiting the add, commit, and push commands](git-and-github/revisiting-the-add-commit-and-push-commands.md)
  * [git add](git-and-github/revisiting-the-add-commit-and-push-commands/git-add.md)
  * [git commit](git-and-github/revisiting-the-add-commit-and-push-commands/git-commit.md)
  * [git push](git-and-github/revisiting-the-add-commit-and-push-commands/git-push.md)
* [Important Git commands](git-and-github/important-git-commands.md)
...
* [Understanding each stage](gcc/understanding-each-stage.md)
  ...
  * [Assembly Language](gcc/understanding-each-stage/assembly-language.md)
  * [High-level Language](gcc/understanding-each-stage/high-level-language.md)
...
* [Interpreting Gprof Output](gprof/interpreting-gprof-output/)

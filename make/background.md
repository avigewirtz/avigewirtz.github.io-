...
The non-incremental build approach to building `testintmath` is as simple as it gets. Each time we want to build `testintmath`, we run the following command: 

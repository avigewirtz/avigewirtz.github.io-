...
`make` prints each of the commands it executes to build the target. Say we're building our program for the first time. `make` will execute and print all three commands:

...
* [Merging](git/merging/README.md)
  ...
  * [Example: fast forward merge](git/merging/example-fast-forward-merge.md)
  * [Example: 3-way merge](git/merging/example-3-way-merge.md)
  * [Example: 3-way merge with conflict](git/merging/example-3-way-merge-with-conflict.md)
  * [Fast-Forward Merge](git/merging/fast-forward-merge.md)
  * [3-Way Merge](git/merging/3-way-merge.md)

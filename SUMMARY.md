...
* [Merging](git/merging/README.md)
  ...
  * [Resolving merge conflicts](git/merging/resolving-merge-conflicts.md)
  * [Rebasing](git/merging/rebasing.md)
* [Working with remotes](git/working-with-remotes/README.md)
  * [Single-developer remote workflow](git/working-with-remotes/single-developer-remote-workflow.md)
  * [Multi-developer remote workflow](git/working-with-remotes/multi-developer-remote-workflow.md)
  * [Pushing and Fetching/Pulling](git/working-with-remotes/pushing-and-pulling.md)
* [Undoing things](git/undoing-things.md)
* [GitHub](git/github/README.md)
  * [Creating a GitHub Account](git/github/creating-a-github-account.md)

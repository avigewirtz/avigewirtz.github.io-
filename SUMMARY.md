...
* [Working with remotes](git/working-with-remotes-1/README.md)
  ...
  * [GItHub workflow](git/working-with-remotes-1/github-workflow.md)
  * [Working with collaborator](git/working-with-remotes-1/working-with-collaborator.md)
  * [Pushing and Fetching/Pulling](git/working-with-remotes-1/pushing-and-pulling.md)
  * [Cloning a Git Repository](git/working-with-remotes-1/cloning-a-git-repository.md)
  * [Remote tracking branches](git/working-with-remotes-1/remote-tracking-branches.md)
* [Undoing things](git/undoing-things.md)
* [GitHub](git/github/README.md)
  * [Creating GitHub Account](git/github/creating-github-account.md)
  * [Creating Repository on GitHub](git/github/creating-repository-on-github.md)
  * [Generating Personal Access Token (PAT)](git/github/generating-personal-access-token-pat.md)

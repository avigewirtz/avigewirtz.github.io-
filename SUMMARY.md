...
* [Local Git Workflow](git/acquiring-a-git-repository/README.md)
  * [Initializing a repository](git/acquiring-a-git-repository/initializing-a-repository.md)
  * [Staging files](git/acquiring-a-git-repository/staging-files.md)
  * [Committing](git/acquiring-a-git-repository/committing.md)
* [Going back in time](git/going-back-in-time.md)
* [Branching](git/branching/README.md)
  * [Merging branches](git/branching/merging-branches.md)
  * [Merge conflicts](git/branching/merge-conflicts.md)
  * [Remote tracking branches](git/branching/remote-tracking-branches.md)
  * [Rebasing](git/branching/rebasing.md)
* [Commits](git/commits/README.md)
  * [Viewing the Commit History](git/commits/viewing-the-commit-history.md)
  * [Viewing Commit History](git/commits/viewing-commit-history.md)
  * [Undoing last commit](git/commits/undoing-last-commit.md)
* [Distributed Git workflow](git/distributed-git-workflow/README.md)
  * [Remotes](git/distributed-git-workflow/remotes.md)
  * [Pushing and Pulling](git/distributed-git-workflow/pushing-and-pulling/README.md)
    * [git push](git/distributed-git-workflow/pushing-and-pulling/pushing-commits.md)
    * [git pull](git/distributed-git-workflow/pushing-and-pulling/git-pull.md)
  * [GitHub](git/distributed-git-workflow/github/README.md)
    * [Authentication](git/distributed-git-workflow/github/authentication.md)

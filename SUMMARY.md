...
* [Working with remotes](git/working-with-remotes/README.md)
  * [Workflow with remotes](git/working-with-remotes/workflow-with-remotes.md)
  * [Pushing and Pulling](git/working-with-remotes/pushing-and-pulling/README.md)
    * [git push](git/working-with-remotes/pushing-and-pulling/pushing-commits.md)
    * [git pull](git/working-with-remotes/pushing-and-pulling/git-pull.md)
  * [GitHub](git/working-with-remotes/github/README.md)
    * [Authentication](git/working-with-remotes/github/authentication.md)
  * [Remote tracking branches](git/working-with-remotes/remote-tracking-branches.md)

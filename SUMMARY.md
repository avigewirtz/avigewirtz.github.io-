...
* [Collaborative workflows](git/collaborative-workflows/README.md)
  * [Workflow with remotes](git/collaborative-workflows/workflow-with-remotes.md)
  * [Pushing and Pulling](git/collaborative-workflows/pushing-and-pulling/README.md)
    * [git push](git/collaborative-workflows/pushing-and-pulling/pushing-commits.md)
    * [git pull](git/collaborative-workflows/pushing-and-pulling/git-pull.md)
  * [GitHub](git/collaborative-workflows/github/README.md)
    * [Authentication](git/collaborative-workflows/github/authentication.md)

...
* [Beginner Local Workflow](git/acquiring-a-git-repository/README.md)
  * [Index](git/acquiring-a-git-repository/index.md)
...
* [Intermediate local workflow: branching and merging](git/intermediate-local-workflow-branching-and-merging/README.md)
  * [Branching](git/intermediate-local-workflow-branching-and-merging/branching.md)
  * [Merging](git/intermediate-local-workflow-branching-and-merging/merging/README.md)
    * [How 3-way merges work](git/intermediate-local-workflow-branching-and-merging/merging/how-3-way-merges-work.md)
    * [Merge examples](git/intermediate-local-workflow-branching-and-merging/merging/merge-examples.md)
    * [Resolving merge conflicts](git/intermediate-local-workflow-branching-and-merging/merging/resolving-merge-conflicts.md)
...
* [Undoing things](git/undoing-things/README.md)
  * [Rebasing](git/undoing-things/rebasing.md)

...
We'll begin our command line journey by executing a few simple Bash commands on Armlab. If you want to follow along with these exercises, it is best if you are [logged into](../armlab/background/logging-into-armlab/) Armlab.&#x20;
